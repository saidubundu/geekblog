...
@section('content')
    <main>
        ...
        <div class="breadcrumb-area pt-30 hero-padding">
            <div class="container">
                <div class="breadcrumb-bg  pt-115 pb-115" style="background-image:url({{asset('img/bg/bg-02.jpg')}})">
                    <div class="row">
                        <div class="col-xl-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-6 mb-30">
                                <div class="lifestyle-text lifestyle-04-text">
                                    <span class="recent-cart color-7"><a href="#">travel</a></span>
                                    <h4><a href="{{route('blog.show', $post->id)}}">{!! str_limit($post->title, 45) !!}</a></h4>
                        ...
                        <div class="banner-2-img mt-25 mb-60">
                            <a href="#"><img src="{{asset('img/banner/003.jpg')}}" alt=""></a>
                        </div>
